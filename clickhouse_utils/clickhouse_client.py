...
class ClickhouseClient:
    def __init__(self, host = None, port = None, user = None, password = None, secure = None, binary = None):
        ...
        self.client = clickhouse_connect.get_client(host=self.host, port=self.port, user=self.user, password=self.password, secure=self.secure, session_id=session_id, connect_timeout=30)
